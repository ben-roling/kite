...
public class TestKeyRangeIterable {
  public static final Constraints emptyConstraints(PartitionStrategy partitionStrategy) {
  ...
  public void testUnbounded() {
    Constraints c = emptyConstraints(id);
  ...
  public void testSingleSet() {
    Constraints c = emptyConstraints(id).with("component", "com.company.Main");
    ...
    c = emptyConstraints(id).with("component",
  ...
  public void testGroupSet() {
    ...
    Constraints c = emptyConstraints(hash).with("id", ids[0]);
    ...
    c = emptyConstraints(hash).with("id", (Object[]) ids);
  ...
  public void testSingleRange() {
    Constraints c = emptyConstraints(num2)
  ...
  public void testHashRange() {
    Constraints c = emptyConstraints(hash).from("id", "0000").toBefore("id", "0001");
  ...
  public void testGroupRange() {
    Constraints c = emptyConstraints(num).from("number", 5).toBefore("number", 18);
    Marker start = new Marker.Builder("id_number", 5).build();
  ...
  public void testTimeSet() {
    ...
    Constraints c = emptyConstraints(time).with("timestamp", (Object[]) timestamps);
  ...
  public void testTimeRange() {
    ...
    Constraints c = emptyConstraints(time)
  ...
  public void testOneSidedRange() {
    ...
    Constraints c = emptyConstraints(time).from("timestamp", 1379020547042L);
